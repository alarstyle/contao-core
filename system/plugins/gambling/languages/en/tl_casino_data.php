...
$GLOBALS['TL_LANG']['tl_casino_data']['deposit_title'] = 'Deposit information';
$GLOBALS['TL_LANG']['tl_casino_data']['providers_title'] = 'Game providers';
$GLOBALS['TL_LANG']['tl_casino_data']['seo'] = 'SEO';
$GLOBALS['TL_LANG']['tl_casino_data']['review_title'] = 'Review';
$GLOBALS['TL_LANG']['tl_casino_data']['pros_cons'] = 'Pros and cons';
$GLOBALS['TL_LANG']['tl_casino_data']['licenses_title'] = 'Licenses';
$GLOBALS['TL_LANG']['tl_casino_data']['contacts'] = 'Contacts';
...
$GLOBALS['TL_LANG']['tl_casino_data']['casino_rating'] = ['Casino rating', 'From 0 to 100'];
$GLOBALS['TL_LANG']['tl_casino_data']['betting_rating'] = ['Betting rating', 'From 0 to 100'];
...
$GLOBALS['TL_LANG']['tl_casino_data']['deposit_bonuses_percent'] = ['Percent', ''];
...
//$GLOBALS['TL_LANG']['tl_casino_data']['spins_2_deposit'] = ['2nd Deposit Free Spins', 'Keep field empty if there is no Free Spins'];
//$GLOBALS['TL_LANG']['tl_casino_data']['cash_3_deposit'] = ['3nd Deposit Cash Bonus', 'Keep field empty if there is no cash bonus'];
...
$GLOBALS['TL_LANG']['tl_casino_data']['withdrawal_max'] = ['Max Amount', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['withdrawal_frequency'] = ['Withdrawal Times', ''];

$GLOBALS['TL_LANG']['tl_casino_data']['deposit_min'] = ['Minimum deposit', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['deposit_max'] = ['Maximum deposit', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['deposit_methods'] = ['Deposit methods', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['providers'] = ['', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['wagering_casino_spins'] = ['For Casino Free Spins', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['wagering_casino_deposit'] = ['For Casino Bonus', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['wagering_casino_type'] = ['Casino Bonus Type', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['wagering_betting_odds'] = ['For Betting Min. Odds', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['wagering_betting_bonus'] = ['For Betting Bonus', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['wagering_betting_type'] = ['Betting Bonus Type', ''];
...
$GLOBALS['TL_LANG']['tl_casino_data']['pros'] = ['Pros', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['cons'] = ['Cons', ''];

$GLOBALS['TL_LANG']['tl_casino_data']['phone'] = ['Contact phone', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['phone_hours'] = ['Phone opening hours', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['livechat'] = ['Livechat available', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['livechat_hours'] = ['Livechat opening hours', ''];
$GLOBALS['TL_LANG']['tl_casino_data']['email'] = ['Email', ''];

$GLOBALS['TL_LANG']['tl_casino_data']['licenses'] = ['', ''];

$GLOBALS['TL_LANG']['tl_casino_data']['review'] = ['', ''];

$GLOBALS['TL_LANG']['tl_casino_data']['published'] = ['Published', ''];