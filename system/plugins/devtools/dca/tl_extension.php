	...
	(
		...
		(
			...
			(
				...
				'href'                => 'key=create',
				'icon'                => 'system/plugins/devtools/assets/apply.gif'
			)
		)
	),
 ...
 */
class tl_extension extends \Contao\Backend
{
	...
	{
		if ($strFolder != $dc->activeRecord->folder && is_dir(TL_ROOT . '/system/plugins/' . $strFolder))
		{
