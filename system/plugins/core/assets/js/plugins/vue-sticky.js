(function () {
    ...
    var StickyDirective = {
        inserted: function (el, binding, vnode) {
            var sticky = new Sticky([el], {stickyClass: 'fixed'});
        }
    };
    ...
    var Sticky = function () {
        ...
        Sticky.prototype.run = function run() {
            ...
            // ###### Added
            _this.forEach(this.selector, function (element) {
        ...
        Sticky.prototype.getStickyContainer = function getStickyContainer(element) {
            ...
            while (container && !container.hasAttribute('data-sticky-container') && container !== document.querySelector('body')) {
