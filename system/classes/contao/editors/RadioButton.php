 ...
 */
class RadioButton extends \Contao\Editor
{
	...
	public function generate()
	{
		...
		{
			$arrOptions[] = sprintf('<input type="radio" name="%s" id="opt_%s" class="tl_radio" value="%s"%s%s onfocus=""> <label for="opt_%s">%s</label>',
									 $this->strName,
									 $this->strId.'_'.$i,
