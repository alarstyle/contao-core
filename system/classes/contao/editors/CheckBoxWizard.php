 ...
 */
class CheckBoxWizard extends \Contao\Editor
{
	...
	{
		return sprintf('<span><input type="checkbox" name="%s" id="opt_%s" class="tl_checkbox" value="%s"%s%s onfocus=""> %s<label for="opt_%s">%s</label></span>',
