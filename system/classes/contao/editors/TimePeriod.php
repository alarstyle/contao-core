 ...
 */
class TimePeriod extends \Contao\Editor
{
	...
	public function generate()
	{
		...
		return sprintf('<input type="text" name="%s[value]" id="ctrl_%s" class="tl_text_interval%s" value="%s"%s onfocus=""> <select name="%s[unit]" class="tl_select_interval" onfocus=""%s>%s</select>%s',
						$this->strName,
						$this->strId,
